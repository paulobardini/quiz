-- ============================================
-- SQL para inserir conteúdo premium dos perfis de CONSTÂNCIA (VERSÃO CORRIGIDA)
-- ============================================
...
-- CONSTÂNCIA MUITO BAIXA
SELECT upsert_premium_content(
  'constancia_muito_baixa',
...
-- CONSTÂNCIA MUITO ALTA
SELECT upsert_premium_content(
  'constancia_muito_alta',
  'Leitura completa do seu padrão de decisão',
  '[
    {
      "order": 1,
